...
class PaymentServiceImplTest {
    ...
    void setup() {
        ...
        Payment voucherPayment = new VoucherPayment("c0f81308-9911-40c5-8da4-fa3194485aa1",
        ...
        Payment bankPayment = new BankPayment("c0f81308-9911-40c5-8da4-fa3194485aa1",
    ...
    void testAddBankPayment() {
        ...
        Payment result = paymentService.addPayment(bankPayment.getMethod(),
            bankPayment.getOrder(), bankPayment.getPaymentData());
    ...
    void testAddVoucherPayment() {
        ...
        Payment result = paymentService.addPayment(voucherPayment.getMethod(),
            voucherPayment.getOrder(), voucherPayment.getPaymentData());
    ...
    void testAddBankPaymentButOrderAlreadyExist() {
        ...
        assertNull(paymentService.addPayment(bankPayment.getMethod(),
            bankPayment.getOrder(), bankPayment.getPaymentData()));
    ...
    void testAddVoucherPaymentButOrderAlreadyExist() {
        ...
        assertNull(paymentService.addPayment(voucherPayment.getMethod(),
            voucherPayment.getOrder(), voucherPayment.getPaymentData()));
    ...
    void testUpdateStatusBankPayment() {
        Payment bankPayment = payments.get(1);
        Payment newBankPayment = new BankPayment(bankPayment.getId(), bankPayment.getMethod(),
            bankPayment.getOrder(), bankPayment.getPaymentData(), PaymentStatus.SUCCESS.getValue());

        doReturn(bankPayment).when(paymentRepository).findById(bankPayment.getId());
        doReturn(newBankPayment).when(paymentRepository).save(any(Payment.class));

        Payment result = paymentService.updatePaymentStatus(bankPayment.getId(), PaymentStatus.SUCCESS.getValue());
    ...
    void testUpdateStatusVoucherPayment() {
        Payment voucherPayment = payments.get(0);
        Payment newVoucherPayment = new VoucherPayment(voucherPayment.getId(), voucherPayment.getMethod(),
            voucherPayment.getOrder(), voucherPayment.getPaymentData(), PaymentStatus.SUCCESS.getValue());

        doReturn(voucherPayment).when(paymentRepository).findById(voucherPayment.getId());
        doReturn(newVoucherPayment).when(paymentRepository).save(any(Payment.class));

        Payment result = paymentService.updatePaymentStatus(voucherPayment.getId(), PaymentStatus.SUCCESS.getValue());
