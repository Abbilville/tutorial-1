...
class VoucherPaymentTest {
    ...
    void testCreateVoucherPaymentPendingStatus() {
        Payment payment = new VoucherPayment("f3b4a3e3-9a7f-4603-92c2-eaf529271cc9", 
    ...
    void testCreateVoucherPaymentSuccessStatus() {
        Payment payment = new VoucherPayment("e45d7d21-fd29-4533-a569-abbe0819579a", 
    ...
    void testCreateVoucherPaymentWithNullOrder() {
        assertThrows(IllegalArgumentException.class, () -> {
            @SuppressWarnings("unused")
            Payment payment = new VoucherPayment("e45d7d21-fd29-4533-a569-abbe0819579a", 
                PaymentMethod.VOUCHER.getValue(), null, paymentData);
        });
    }
    ...
    void testCreateVoucherPaymentWithNullPaymentData() {
        assertThrows(IllegalArgumentException.class, () -> {
            @SuppressWarnings("unused")
            Payment payment = new VoucherPayment("e45d7d21-fd29-4533-a569-abbe0819579a", 
                PaymentMethod.VOUCHER.getValue(), order, null);
        });
    }
